...
func (t *tcpPublisher) Publish(topic, broker string, in io.Reader, extra ...interface{}) (err error) {
	return nil
}

func (t *tcpPublisher) AvailableBrokersCount() int32 {
	return 0
}

// watch the available broker connection.
func (t *tcpPublisher) Heartbeat()   {}
...
func initServerQ(port int) {
	...
	if err != nil {
		logx.L().Panicf("err tcp setup, %v", err)
		return
	}
